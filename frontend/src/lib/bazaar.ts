...
const MOCK_RESOURCES: BazaarResource[] = [
  ...
  },
  {
    ...
    amountMicros: 250000,
    asset: "31566704",
    payTo: "AQYWNHO6QWB4AB4SHIVMNZL2QN2ZQIYYO3Z27DJCUOILZ43YGGZUIPAURY",
    // Empty for a simpler reason than Prism's: HelixBox's endpoints take no
    // input at all, as their own 402 challenge declares.
    params: [],
    settleCount: 24,
  ...
  {
    id: "curated:helixbox-agent-session-hour",
    url: "https://helixbox-manager.onrender.com/v2/x402/agent-session-1hour",
    method: "POST",
  ...
  {
    id: "curated:helixbox-premium-week",
    url: "https://helixbox-manager.onrender.com/v2/x402/premium/week",
    method: "POST",
